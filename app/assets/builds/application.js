    ...
    "node_modules/jquery-mask-plugin/dist/jquery.mask.js"(exports, module) {
      (function(factory, jQuery, Zepto) {
        ...
        var Mask = function(el, mask, options) {
          var p = {
            ...
            events: function() {
              ...
              }).on($2.jMaskGlobals.useInput ? "input.mask" : "keyup.mask", p.behaviour).on("paste.mask drop.mask", function() {
                setTimeout(function() {
                  el.keydown().keyup();
                }, 100);
            ...
            getMasked: function(skipMaskChars, val) {
              var buf = [], value = val === void 0 ? p.val() : val + "", m = 0, maskLen = mask.length, v = 0, valLen = value.length, offset2 = 1, addMethod = "push", resetPos = -1, maskDigitCount = 0, maskDigitPosArr = [], lastMaskChar, check;
              if (options.reverse) {
                addMethod = "unshift";
                offset2 = -1;
                lastMaskChar = 0;
          ...
          jMask.init = function(onlyMask) {
            ...
            options = options || {};
            jMask.clearIfNotMatch = $2.jMaskGlobals.clearIfNotMatch;
            jMask.byPassKeys = $2.jMaskGlobals.byPassKeys;
            jMask.translation = $2.extend({}, $2.jMaskGlobals.translation, options.translation);
            jMask = $2.extend(true, {}, jMask, options);
        ...
        var HTMLAttributes = function() {
          var input = $2(this), options = {}, prefix = "data-mask-", mask = input.attr("data-mask");
          ...
          options = options || {};
          var maskObject = $2(field).data("mask"), stringify = JSON.stringify, value = $2(field).val() || $2(field).text();
          try {
        ...
        $2.fn.mask = function(mask, options) {
          options = options || {};
          var selector = this.selector, globals2 = $2.jMaskGlobals, interval = globals2.watchInterval, watchInputs = options.watchInputs || globals2.watchInputs, maskFunction = function() {
            if (notSameMaskObject(this, mask, options)) {
              return $2(this).data("mask", new Mask(this, mask, options));
            }
          };
          $2(this).each(maskFunction);
          if (selector && selector !== "" && watchInputs) {
            clearInterval($2.maskWatchers[selector]);
            $2.maskWatchers[selector] = setInterval(function() {
              $2(document).find(selector).each(maskFunction);
            }, interval);
          }
          return this;
        };
        $2.fn.masked = function(val) {
          return this.data("mask").getMaskedVal(val);
        };
        $2.fn.unmask = function() {
          clearInterval($2.maskWatchers[this.selector]);
          delete $2.maskWatchers[this.selector];
          return this.each(function() {
            var dataMask = $2(this).data("mask");
            if (dataMask) {
              dataMask.remove().removeData("mask");
            }
          });
        };
        $2.fn.cleanVal = function() {
          return this.data("mask").getCleanVal();
        };
        $2.applyDataMask = function(selector) {
          selector = selector || $2.jMaskGlobals.maskElements;
          var $selector = selector instanceof $2 ? selector : $2(selector);
          $selector.filter($2.jMaskGlobals.dataMaskAttr).each(HTMLAttributes);
        };
        var globals = {
        ...
        $2.jMaskGlobals = $2.jMaskGlobals || {};
        globals = $2.jMaskGlobals = $2.extend(true, {}, globals, $2.jMaskGlobals);
        if (globals.dataMask) {
          $2.applyDataMask();
        }
        setInterval(function() {
          if ($2.jMaskGlobals.watchDataMask) {
            $2.applyDataMask();
          }
...
%o`, message, error2, detail);
  ...
  // app/javascript/controllers/masks_controller.js
  window.$ = window.jQuery = require_jquery();
  require_jquery_mask();
  var masks_controller_default = class extends Controller {
    connect() {
      this.maskFields();
    }
    maskFields() {
  ...
  application.register("masks", masks_controller_default);
